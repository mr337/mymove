...
describe('StorageInTransit tests', () => {
  describe('When no items exist', () => {
    ...
    it('renders without crashing', () => {
      expect(wrapper.find('[data-test="storage-in-transit-panel"]').length).toEqual(1);
    });
  });
  describe('When no items exists and Request SIT appears on TSP app', () => {
    ...
    it('renders without crashing', () => {
      expect(wrapper.find('[data-test="storage-in-transit-panel"]').length).toEqual(1);
      expect(wrapper.find('[data-test="add-request"]').length).toEqual(1);
    });
  });
  describe('When no items exists and Request SIT appears on Office app', () => {
    ...
    it('renders without crashing', () => {
      expect(wrapper.find('[data-test="storage-in-transit-panel"]').length).toEqual(1);
      expect(wrapper.find('[data-test="add-request"]').length).toEqual(0);
    });
  });
